...
class LlmClient:
    ...
    def query_lm_studio(self, instruction):
        ...
        system_prompt = (
            ...
            "Schema: {\"commands\": [ {\"type\": one_of(forward, backward, turn, spin, face, goto, speed, expression, parameter, reset, effect, look, motion, humor, register_landmark, remove_landmark), \"value\": any } ], \"cancel\": boolean, \"speak\": string?}\n"
            ...
            "For standard motion macros, use type motion with value {\"id\":\"sway\"}, {\"id\":\"dance\"}, or {\"id\":\"spin\"}; ask a clarification if the motion name is not one of those.\n"
            ...
            "If the user asks to delete, clear, cancel, or remove a registered landmark by name, output a remove_landmark command with the name as the value.\n"
