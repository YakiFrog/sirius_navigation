...
class LlmClient:
    ...
    def query_lm_studio(self, instruction):
        ...
        system_prompt = (
            ...
            "Schema: {\"commands\": [ {\"type\": one_of(forward, backward, turn, spin, face, goto, speed, expression, parameter, reset, effect, look, humor, register_landmark, remove_landmark), \"value\": any } ], \"cancel\": boolean, \"speak\": string?}\n"
